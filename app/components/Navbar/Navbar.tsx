...
//   { name: "Presentations", href: "#testimonial-section" },
//   { name: "Recordings", href: "#join-section" },
...
//   // Detect light or dark section pages (like /courses/slug)
//   const isLightPage = pathname.startsWith("/courses");
